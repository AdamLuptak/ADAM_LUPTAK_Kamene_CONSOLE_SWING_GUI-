...
public class Ui implements InterFace {
	...
	public void newGameStarted(NumberTilesField playingField) {
		...
		System.out.println("---- Best times player name and time ----");
	...
	private void processInput() {
		...
		if (inputText.equals("w") || inputText.equals("up")) {// hore
			...
			try {
				System.err.println("zli vstup chlapce");
				Thread.sleep(1000);
				clc(1000);
	...
	public void update() {
		Puzzle.getInstance();
		System.out.printf("Game state: %10s Player Time: %2s s%n", playingField.getGamteState(),
