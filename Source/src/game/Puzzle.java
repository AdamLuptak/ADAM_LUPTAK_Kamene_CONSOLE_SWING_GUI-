...
public class Puzzle {
	...
	/**
	 * here is method which return playing time seconds
	 */
	...
	private Puzzle() {
		...
		//NumberTilesField playingField = new NumberTilesField(4, 4);
	...
	private static void handlingInput(String input) throws WrongFormatException {
		Matcher matcher = (Pattern.compile("(1)|(2)")).matcher(input);
		if (matcher.matches()) {
